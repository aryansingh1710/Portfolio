  ...
  return (
    <>
      ...
      ">
        ...
        {/* --- Background Effects --- */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80vw] h-[80vw] bg-purple-900/10 rounded-full blur-[100px] pointer-events-none z-0"></div>
        ...
        {/* 3. Custom Gradient Border Button */}
        <div className="relative z-10 w-full sm:w-auto gradien-btn">
          ...
          <a href="/resume.pdf" className="group relative inline-block p-[2px] rounded-full bg-gradient-to-r from-[#FF4D6D] via-[#7B2FF7] to-[#2FF7ED]">
            ...
            {/* Inner Content: Initially Black, Becomes Transparent on Hover */}
            <span className="
        ...
        {/* 4. Star SVG */}
        <div className="star absolute -z-10 pointer-events-none
